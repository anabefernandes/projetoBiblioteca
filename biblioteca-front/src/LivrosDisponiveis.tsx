...
export const LivrosDisponiveis: React.FC = () => {
  ...
  const livrosDisponiveis = livros.filter((livro) => livro.disponibilidade);

  const filtrarLivros = livrosDisponiveis.filter((livro) =>
  ...
  return (
    <>
      ...
      <div className="volte" style={{
        ...
        <h2 className="titulo-principal">Livros Disponíveis</h2>
        ...
        <div className="card-grid">
          {filtrarLivros.length > 0 ? (
            ...
            <div className="no-books">
              <img src={noBooks} alt="Nenhum livro disponível" />
            </div>
          )}
        </div>
      </div>
